...
* [Wide area network](https://en.wikipedia.org/wiki/Wide_area_network) (WAN)
  ...
  * [Internationalization and localization](https://en.wikipedia.org/wiki/Internationalization_and_localization) (i18n and l10n)
...
* [Command-line interface](https://en.wikipedia.org/wiki/Command-line_interface) (CLI)
  * [Termina emulator](https://en.wikipedia.org/wiki/Terminal_emulator)
    ...
    * [Natural Language Shell](https://github.com/PsychArch/nlsh) (nlsh)
    * [Z shell](https://en.wikipedia.org/wiki/Z_shell) (Zsh)
